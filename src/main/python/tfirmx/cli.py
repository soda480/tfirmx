...
from .screen_layout import get_screen_layout
...
def get_servers2(**kwargs):
    """ getting server data from enclosure if being passed as get_process_data value
        to MPcurses then should accept **kwargs as argument
    """
    bays = range(1, 17)
    servers = []
    for bay in bays:
